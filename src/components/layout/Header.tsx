...
export const Header: React.FC = () => {
  return (
    <header className="flex justify-between items-center bg-white px-4 md:px-12 lg:px-24 py-[37px] max-sm:p-5">
      ...
      <button className="flex items-center gap-1.5 text-white text-[12.8px] bg-[#0466C8] px-4 md:px-[45px] py-[17px] rounded-[50px]">
        <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M8.69986 8.1C7.98236 8.1 7.63736 8.5 6.45986 8.5C5.28236 8.5 4.93986 8.1 4.21986 8.1C2.36486 8.1 0.859863 9.605 0.859863 11.46V12.1C0.859863 12.7625 1.39736 13.3 2.05986 13.3H10.8599C11.5224 13.3 12.0599 12.7625 12.0599 12.1V11.46C12.0599 9.605 10.5549 8.1 8.69986 8.1Z" fill="white"/>
        </svg>

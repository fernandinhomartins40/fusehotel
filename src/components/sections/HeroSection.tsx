...
export const HeroSection: React.FC = () => {
  return (
    <section className="h-[700px] px-[360px] py-[121px] max-md:px-5 max-md:py-10 bg-[url('URL_HERO_BG')]">
      <div>
        ...
        <div className="flex items-center gap-[15px]">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/36afb6fdc33268c98afeed341131e7ec15a32d1a"
            alt="Rating stars"

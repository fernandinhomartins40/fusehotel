...
export const RoomCard: React.FC<RoomCardProps> = ({
  ...
  const borderRadius = themedConfig.cardBorderRadius || '12px';

  return (
    <div
      className="w-full border overflow-hidden border-solid card-hover group"
      style={{
    ...
    >
      <div className="relative img-zoom">
        ...
        <div
          className="absolute text-xs font-semibold uppercase px-3.5 py-1.5 top-4 left-4 rounded-sm tracking-wide"
          style={{
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between pt-4">
          <div className="text-sm" style={{ color: priceLabelColor }}>
            ...
            <span className="text-base font-bold" style={{ color: priceValueColor }}>{price}</span>
          </div>

          <Link to={linkPath}>
            <Button
              variant="outline"
              className="transition-all duration-300 rounded-lg text-sm"
              style={{

  ...
  return (
    <div className="card-modern group">
      ...
      <div className="relative img-zoom">
        ...
        <div
          className="absolute text-[11px] font-semibold uppercase px-4 py-2 top-4 left-4 rounded-full tracking-wider backdrop-blur-sm"
          style={{
      ...
      <div className="p-7">
        ...
        <div className="flex gap-5 py-4 border-t border-gray-100">
          <div className="flex items-center gap-2 text-[13px]" style={{ color: descriptionColor }}>
        ...
        <div className="flex items-center justify-between pt-5">
          ...
          <Link to={linkPath}>
            <Button
              variant="outline"
              className="group/btn transition-all duration-300 rounded-full text-sm px-5 gap-2"
              style={{

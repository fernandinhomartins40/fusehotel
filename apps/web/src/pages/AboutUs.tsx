      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="page-container text-center relative">
            ...
            <p
              className="text-base md:text-lg leading-relaxed mx-auto max-w-3xl opacity-80"
        ...
        >
          <div className="page-container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-2xl overflow-hidden shadow-2xl h-96 img-zoom">
                <img
        ...
        <section
          className="page-section"
          style={{ backgroundColor: mvvConfig.backgroundColor || '#F5F5F0' }}
        >
          <div className="page-container">
            ...
            >
              {teamMembers.map((member: TeamMember) => (
                <div key={member.id} className="flex flex-col items-center group">
                  <div className="w-44 h-44 rounded-full overflow-hidden mb-5 shadow-lg transition-all duration-500 group-hover:shadow-xl group-hover:scale-105">
                    <img
                      src={member.image}
                      alt={member.name}
                      className="w-full h-full object-cover"
        ...
        <section
          className="page-section"
          style={{ backgroundColor: awardsConfig.backgroundColor || '#F5F5F0' }}
        >
          <div className="page-container">
            <div className="text-center mb-16">
              <div className="line-accent mx-auto mb-6" />
            ...
            >
              {awards.map((award: Award) => (
                <div
                  key={award.id}
                  className="card-modern p-6 flex flex-col items-center text-center"
                >
                  <div

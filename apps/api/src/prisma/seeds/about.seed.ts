  ...
  const teamMembers = [
    {
      ...
      name: 'Ana Oliveira',
      role: 'Diretora Geral',
      description: 'Com mais de 20 anos de experiência em hotelaria, Ana lidera nossa equipe com dedicação e visão inovadora.',
      image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixid=MnwxfDB8MXxyYW5kb218MHx8cGVyc29ufHx8fHx8MTY4MzczNzY1MQ&ixlib=rb-4.0.3&q=80&w=300',
      order: 1,
      isActive: true
    },
    {
      ...
      name: 'Carlos Santos',
      role: 'Chef Executivo',
      description: 'Formado na França, Carlos traz para nossa cozinha o melhor da gastronomia internacional com toques regionais.',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixid=MnwxfDB8MXxyYW5kb218MHx8bWFufHx8fHx8MTY4MzczNzY5NA&ixlib=rb-4.0.3&q=80&w=300',
      order: 2,
      isActive: true
    },
    {
      ...
      description: 'Especialista em atendimento ao cliente, Mariana garante que cada hóspede tenha uma experiência memorável.',
      image: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixid=MnwxfDB8MXxyYW5kb218MHx8d29tYW58fHx8fHwxNjgzNzM3NzQy&ixlib=rb-4.0.3&q=80&w=300',
      order: 3,
      isActive: true
    }
  ];

...
export async function seedPmsData() {
  ...
  const posOrdersSeed: any[] = [
    ...
    { orderNumber: 'POS-SEED-007', origin: POSOrderOrigin.ROOM_SERVICE, settlementType: POSSettlementType.FOLIO, status: POSOrderStatus.OPEN, customerName: 'João Silva', roomCode: '101', stayCode: 'FH-SEED-260426-001', notes: 'Hóspede pediu reposição de frigobar e sanduíche; aguardando preparo.', serviceFeeAmount: 0, discountAmount: 0, items: [{ sku: 'BEB-001', quantity: 2 }, { sku: 'ALM-002', quantity: 1 }], createdAt: setHour(today, 10, 25) },
    { orderNumber: 'POS-SEED-008', origin: POSOrderOrigin.ROOM_SERVICE, settlementType: POSSettlementType.FOLIO, status: POSOrderStatus.PREPARING, customerName: 'Marcelo Torres', roomCode: '302', stayCode: 'FH-SEED-260426-012', notes: 'Walk-in solicitou café da manhã reforçado no quarto.', serviceFeeAmount: 0, discountAmount: 0, items: [{ sku: 'ALM-001', quantity: 2 }, { sku: 'ALM-003', quantity: 1 }, { sku: 'BEB-004', quantity: 1 }], createdAt: setHour(today, 8, 40) },
    { orderNumber: 'POS-SEED-009', origin: POSOrderOrigin.FRONTDESK, settlementType: POSSettlementType.DIRECT, status: POSOrderStatus.OPEN, customerName: 'Helena Duarte', notes: 'Venda pendente de kit premium e protetor solar na recepção.', serviceFeeAmount: 0, discountAmount: 0, items: [{ sku: 'CON-001', quantity: 1 }, { sku: 'CON-002', quantity: 1 }], cashSessionId: openCashSession.id, createdAt: setHour(today, 11, 50) },
    { orderNumber: 'POS-SEED-010', origin: POSOrderOrigin.ROOM_SERVICE, settlementType: POSSettlementType.FOLIO, status: POSOrderStatus.OPEN, customerName: 'Renata Brandão', roomCode: 'VIL-01', stayCode: 'FH-SEED-260426-010', notes: 'Villa presidencial com solicitação de espumante, gelo e sobremesa para reunião interna.', serviceFeeAmount: 0, discountAmount: 0, items: [{ sku: 'BEB-006', quantity: 2 }, { sku: 'OUT-001', quantity: 1 }, { sku: 'ALM-006', quantity: 4 }], createdAt: setHour(today, 13, 35) },
    { orderNumber: 'POS-SEED-011', origin: POSOrderOrigin.RESTAURANT, settlementType: POSSettlementType.DIRECT, status: POSOrderStatus.DELIVERED, customerName: 'Mesa 15', tableNumber: 'M15', notes: 'Pedido entregue no restaurante e aguardando recebimento no caixa.', serviceFeeAmount: 7, discountAmount: 0, items: [{ sku: 'ALM-004', quantity: 2 }, { sku: 'BEB-005', quantity: 3 }], cashSessionId: openCashSession.id, createdAt: setHour(today, 21, 5) },
    { orderNumber: 'POS-SEED-012', origin: POSOrderOrigin.ROOM_SERVICE, settlementType: POSSettlementType.FOLIO, status: POSOrderStatus.DELIVERED, customerName: 'João Silva', roomCode: '101', stayCode: 'FH-SEED-260426-001', notes: 'Pedido noturno entregue; recepção pode testar abertura da conta do hóspede a partir do PDV.', serviceFeeAmount: 0, discountAmount: 0, items: [{ sku: 'ALM-005', quantity: 1 }, { sku: 'BEB-005', quantity: 2 }], createdAt: setHour(today, 22, 10) },
  ];
